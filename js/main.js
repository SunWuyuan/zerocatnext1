...
function userinfo() {
  ...
  if (Cookies.get("token")) {
    try {
      ...
      $(".ow-useravatar").attr("src", config.s3url+"/user/" + decoded.avatar);
  ...
  if (Cookies.get("token") == undefined) {
    try {
      localStorage.setItem('token','')
        ...
        '<mdui-list-item rounded href="/account/login.html">注册</mdui-list-item> <mdui-list-item rounded href="/account/login.html">登录</mdui-list-item><mdui-list-item rounded class="close-user" icon="arrow_left">关闭</mdui-list-item>';
