...
function projecthtml(type, d) {
  ...
  <mdui-card clickable href="/scratch/play.html?id=${d.id}">
    <img src="${config.s3url}/scratch_slt/${d.id}"   onerror="this.onerror=null; this.src='${staticurl}/img/scratchdefault.png';"
  ...
  <div href='/user.html?id=${d.authorid}' style="padding: 16px;">
    <img class="card-avatar" src="${config.s3url}/user/${d.images}" />
