...
function show_python_userinfo(work) {
  ...
  document.querySelector('#authorinfo').setAttribute('href','/user.html?id=' + work.id);
  document.querySelector('#authoravatar').setAttribute('src', config.s3url+'/user/'+work.images);
