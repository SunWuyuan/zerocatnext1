...
<mdui-card clickable href="/scratch/play.html?id=${d[i].id}">
  <img src="${config.s3url}/scratch_slt/${d[i].id}"   onerror="this.onerror=null; this.src='/assets/images/scratchdefault.png';"
...
<div href='/user.html?id=${d[i].authorid}' style="padding: 16px;">
  <img class="card-avatar" src="${config.s3url}/user/${d[i].images}" />
